...
os.environ["HF_HOME"]= r"E:\acmm_mpdd\embedding"
import json
import numpy as np
import torch
...
def main():
    ...
    json_file = r"E:\acmm_mpdd\Testing\labels\personalized_descriptions_test.json"

    # Path to save the output embeddings
    output_file = r"E:\acmm_mpdd\Testing\labels/descriptions_embeddings_with_ids_bge_zh_ds_test.npy"
